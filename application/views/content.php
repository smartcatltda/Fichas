...
<div class="container-fluid">  
    <div class="row" id="login" hidden>
        <div class="col-lg-4 col-lg-offset-4">
            <section class="login">
                <img src="css/images/logo.png" class="img-responsive img-circle center-block" alt="Responsive image">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        <li>
                            <a href="#"><i class="fa fa-fw fa-file"></i> Ficha</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-fw fa-users"></i> Usuarios</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-fw fa-bar-chart-o"></i> Reportes</a>
                        </li>
                ...
                <div id="mantenedor_usuario" class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-12 separador">
                            <button type="button" id="bt_limpiar" class="btn btn-lg btn-warning btn-block"><span class="fa fa-fw fa-refresh"></span> Limpiar</button>
                        </div>
                        <div class="col-lg-3 col-lg-offset-6 col-md-12 separador">
                            <button type="button" id="bt_guardar" class="btn btn-lg btn-primary btn-block"><span class="fa fa-fw fa-save"></span> Guardar</button>
                        </div>
                    </div>
                    <div class="row">
                        <h2 class="page-header text-center">Lista de Usuarios</h2>
                        <div class="col-lg-12">
                            <div id="lista_usuario" class="table-responsive">
